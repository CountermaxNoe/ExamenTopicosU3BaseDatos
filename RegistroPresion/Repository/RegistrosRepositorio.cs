...
namespace RegistroPresion.Repository
{
    public class RegistrosRepositorio
    {
        SQLiteConnection conexion;

        public RegistrosRepositorio() 
        {
        ...
        public static string ObtenerCategoria(int sistolica, int diastolica)
        {
